  ...
  return (
    <div className='bg-yellow-900 w-full max-w-[600px] flex'>
      ...
      <div
        ...
        className={
          queryValue.length > 0
            ? 'bg-primary-900 basis-[50px] h-full w-[50px] text-white text-3xl flex items-center justify-center hover:bg-primary-700 cursor-pointer'
            : 'bg-primary-900 basis-[50px] h-full w-[50px] text-white text-3xl flex items-center justify-center hover:bg-primary-700 cursor-not-allowed'
        }
      >
        <AiOutlineSearch />
      </div>
